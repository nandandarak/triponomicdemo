        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between gap-2">
            ...
            <Link to="/" className="flex items-center gap-2 sm:gap-3 group">
              ...
              <div>
                <div className="flex items-center gap-1.5 sm:gap-2">
                  <span
                    className={`font-bold tracking-wide text-xs sm:text-base ${
                      theme === "light" ? "text-slate-900" : "text-white"
                    }`}
                  >
                    TRIPONOMIC
                  </span>
                  <span className="text-[9px] sm:text-[10px] uppercase font-bold tracking-widest bg-amber-400/20 text-amber-600 dark:text-amber-300 border border-amber-400/30 px-1.5 sm:px-2 py-0.5 rounded-full flex items-center gap-1 whitespace-nowrap">
                    <ShieldCheck className="w-3 h-3" /> <span className="hidden xs:inline">Admin</span> Portal
                  </span>
                </div>
                <p
          ...
          <div className="flex items-center gap-1.5 sm:gap-2.5 shrink-0">
            ...
            <button
              ...
              onClick={() => syncNow()}
              disabled={isSyncing}
              className={`flex items-center gap-1.5 text-xs font-semibold px-2 sm:px-3 py-1.5 rounded-lg border transition-all cursor-pointer shadow-sm ${
                isSyncing
            ...
            <Link
              ...
              target="_blank"
              rel="noreferrer"
              className={`flex items-center gap-1.5 text-xs font-semibold px-2 sm:px-3 py-1.5 rounded-lg transition ${
                theme === "light"
            ...
            <button
              ...
              className="flex items-center gap-1.5 text-xs font-semibold px-2 sm:px-3 py-1.5 rounded-lg bg-red-500/20 hover:bg-red-500/30 text-red-400 border border-red-500/30 transition cursor-pointer"
