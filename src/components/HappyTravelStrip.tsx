  ...
  const highlights = [
    {
      icon: Compass,
      title: "100% Your Way",
      desc: "Every trip is built around what you love",
      color: "#059669",
      bgColor: "#ECFDF5",
    },
    {
      icon: Star,
      title: "Top Hotel Stays",
      desc: "Best 5-star & boutique hotels at great prices",
      color: "#D97706",
      bgColor: "#FFFBEB",
    },
    {
      ...
      desc: "Flights, visas, cabs & guides — all sorted for you",
      color: "#0284C7",
      bgColor: "#F0F9FF",
    },
    {
      ...
      desc: "Just WhatsApp us anytime, we're always around",
      color: "#7C3AED",
      bgColor: "#F5F3FF",
    },
  ];
